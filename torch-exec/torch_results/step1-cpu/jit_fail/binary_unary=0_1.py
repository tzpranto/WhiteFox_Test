...
jit:
Failed running call_function <built-in method conv2d of type object at 0x7fd69045f1c0>(*(FakeTensor(..., size=(1, 8, 64, 64)), Parameter(FakeTensor(..., size=(32, 32, 1, 1), requires_grad=True)), Parameter(FakeTensor(..., size=(32,), requires_grad=True)), (1, 1), (0, 0), (1, 1), 1), **{}):
Given groups=1, weight of size [32, 32, 1, 1], expected input[1, 8, 64, 64] to have 32 channels, but got 8 channels instead
