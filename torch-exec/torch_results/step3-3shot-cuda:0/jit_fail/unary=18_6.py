...
jit:
Failed running call_function <built-in method conv2d of type object at 0x7f97acc5f1c0>(*(FakeTensor(..., device='cuda:0', size=(1, 1, 64, 64, 64)), Parameter(FakeTensor(..., device='cuda:0', size=(2, 1, 1, 1), requires_grad=True)), Parameter(FakeTensor(..., device='cuda:0', size=(2,), requires_grad=True)), (1, 1), (1, 1), (1, 1), 1), **{}):
Expected 3D (unbatched) or 4D (batched) input to conv2d, but got input of size: [1, 1, 64, 64, 64]
