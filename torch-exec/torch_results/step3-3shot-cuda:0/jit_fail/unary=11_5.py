...
jit:
Failed running call_function <built-in method conv_transpose2d of type object at 0x7fc5d5c5f1c0>(*(FakeTensor(..., device='cuda:0', size=(1, 8, 64, 64)), Parameter(FakeTensor(..., device='cuda:0', size=(3, 8, 3, 3), requires_grad=True)), Parameter(FakeTensor(..., device='cuda:0', size=(8,), requires_grad=True)), (1, 1), (1, 1), (0, 0), 1, (1, 1)), **{}):
Given transposed=1, weight of size [3, 8, 3, 3], expected input[1, 8, 64, 64] to have 3 channels, but got 8 channels instead
