...
jit:
Failed running call_function <built-in method where of type object at 0x7ff8e7e5f1c0>(*(FakeTensor(..., device='cuda:0', size=(1, 8, 66, 66)), FakeTensor(..., device='cuda:0', size=(1, 8, 66, 66)), FakeTensor(..., device='cuda:0', size=(1, 8, 66, 66))), **{}):
