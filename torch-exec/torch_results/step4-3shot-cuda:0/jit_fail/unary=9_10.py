...
jit:
Failed running call_function <built-in method conv2d of type object at 0x7f361445f1c0>(*(FakeTensor(..., device='cuda:0', size=(1, 6, 64, 64)), Parameter(FakeTensor(..., device='cuda:0', size=(8, 3, 1, 1), requires_grad=True)), Parameter(FakeTensor(..., device='cuda:0', size=(8,), requires_grad=True)), (1, 1), (1, 1), (1, 1), 1), **{}):
Given groups=1, weight of size [8, 3, 1, 1], expected input[1, 6, 64, 64] to have 3 channels, but got 6 channels instead
