...
jit:
Failed running call_function <built-in method conv2d of type object at 0x7f9364a5f1c0>(*(FakeTensor(..., device='cuda:0', size=(1, 8, 8, 8)), Parameter(FakeTensor(..., device='cuda:0', size=(8, 3, 3, 3), requires_grad=True)), Parameter(FakeTensor(..., device='cuda:0', size=(8,), requires_grad=True)), (2, 2), (1, 1), (1, 1), 1), **{}):
Given groups=1, weight of size [8, 3, 3, 3], expected input[1, 8, 8, 8] to have 3 channels, but got 8 channels instead
