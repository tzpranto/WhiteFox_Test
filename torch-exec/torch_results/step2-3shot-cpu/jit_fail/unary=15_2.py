...
jit:
Failed running call_function <built-in method conv2d of type object at 0x7fcca5a5f1c0>(*(FakeTensor(..., size=(1, 8, 66, 66)), Parameter(FakeTensor(..., size=(8, 3, 1, 1), requires_grad=True)), Parameter(FakeTensor(..., size=(8,), requires_grad=True)), (1, 1), (1, 1), (1, 1), 1), **{}):
Given groups=1, weight of size [8, 3, 1, 1], expected input[1, 8, 66, 66] to have 3 channels, but got 8 channels instead
