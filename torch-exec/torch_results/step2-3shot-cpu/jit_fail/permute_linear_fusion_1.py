...
jit:
Failed running call_function <built-in method conv2d of type object at 0x7f84bce5f1c0>(*(FakeTensor(..., size=(1, 2, 2)), Parameter(FakeTensor(..., size=(2, 1, 3, 3), requires_grad=True)), Parameter(FakeTensor(..., size=(2,), requires_grad=True)), (1, 1), (0, 0), (1, 1), 1), **{}):
Calculated padded input size per channel: (2 x 2). Kernel size: (3 x 3). Kernel size can't be greater than actual input size
